...
CREATE TABLE IF NOT EXISTS "Books" (
    ...
    "image_path" VARCHAR(1000) NOT NULL DEFAULT 'frontend/src/main/resources/image/default/book.png',
    "description" TEXT,
    "placeAt" VARCHAR(250),
...
CREATE TABLE IF NOT EXISTS "Members" (
    ...
    "image_path" VARCHAR(1000) NOT NULL DEFAULT 'frontend/src/main/resources/image/default/avatar.png',
